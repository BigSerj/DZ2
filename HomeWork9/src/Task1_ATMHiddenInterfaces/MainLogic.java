...
public class MainLogic{
    ...
    public static void main(String[] args) {
        ...
        main.newATM.setListener(main.listenetr);
    ...
    private ATMListener listenetr = new ATMListener() {   // АНОНИМНЫЙ КЛАСС (потому что никто не знает его имени). Нужен для того, чтобы конкретно при вызове этой ф-ии сработал именно этот код
